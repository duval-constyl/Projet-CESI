    ...
    <div class="zone">
      <form class="login100-form connexion-form" enctype="multipart/form-data">
        <!--initialisation du logo  du site-->  
          ...
          <!--connexion au site-->
          <div class="login100-form-title p-b-32">Publications
        </div> 
        <br>
		<div class="youremail"><p>your description</p></div>
          <!--entrer de l'e-mail-->
          <div class="wrap-input100 validate-input" data-validate = "put your address e-mail">
              <input class="input100" type="email" name="">
        ...
        <!--entrer le pseudo-->
        <br>
		<div class="youremail"><p>localisation</p></div>
          ...
          <br>
           ...
           <label for="subject"><b>Attachements</b></label>
